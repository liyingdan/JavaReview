...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2019091516280444.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDIxMDk2NQ==,size_16,color_FFFFFF,t_70)
##### 1.1 顺序表类的描述如下：
...
### 2.线性表的链式存储
##### 2.1单链表
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190915163047527.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDIxMDk2NQ==,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190915163241857.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDIxMDk2NQ==,size_16,color_FFFFFF,t_70)
在实际应用中往往使用**尾指针**来标识循环链表，这样无论是访问第一个结点还是访问最后一个结点其时间复杂度都是O(1)。
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190915163417994.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDIxMDk2NQ==,size_16,color_FFFFFF,t_70)
**合并两个循环链表：**
...
---
##### 2.3 双向链表
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190915163604339.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDIxMDk2NQ==,size_16,color_FFFFFF,t_70)
**2.3.1 双向链表的结点类:**
```java
/**
 * 双向链表的结点类
